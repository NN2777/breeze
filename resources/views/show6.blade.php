    ...
    function processElement(element) {
      for (var i = 0; i < element.length; i++) {
          ...
          switch (obj.nodetype) {
              ...
              case "Assign":
                  var label = obj.name + " = " + obj.dtype;
                  nodes.push({ id: parent + id + branch, shape: "hexagon", label: label });
                  break;    
              case "Input":
                  var label = obj.prompt + " " + obj.name;
                  nodes.push({ id: id, shape: "parallelogram", label: label });
              ...
              case "Selection":
                  ...
                  nodes.push({ id: id, shape: "diamond", label: label });
          ...
          // Add edges between nodes based on the array index
          // if (i > 0) {
          //     var from = parent + element[i - 1].id + branch;
          //     var to = parent + id + branch;
          //     edges.push({ from: from, to: to });
          // }
      }
