...
function generateFlowchart(element) {
  ...
  function processSelection(trueBranch, falseBranch, id) {
    ...
    if (trueBranch) {
      for (let index = 0; index < trueBranch.length; index++) {
        processNode(trueBranch[index]);
        console.log(trueBranch[index]);
      }
    }
    ...
    if (falseBranch) {
      ...
      for (let index = 0; index < falseBranch.length; index++) {
        processNode(falseBranch[index]);
      }
    }
  }
